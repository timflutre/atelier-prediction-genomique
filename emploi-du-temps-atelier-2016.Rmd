...
+ [knitr](https://cran.r-project.org/web/packages/knitr/), [rmarkdown](https://cran.r-project.org/web/packages/rmarkdown/): pour les rapports;
+ [MASS](https://cran.r-project.org/web/packages/MASS/): pour les simulations;
