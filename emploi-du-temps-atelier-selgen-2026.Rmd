...
author: "M. Tavaud and Co :voir liste ci-dessous"
...
* Contact
[Muriel Tavaud](mailto:muriel.tavaud@supagro.fr) ([Institut Agro Montpellier](https://www.institut-agro-montpellier.fr/), [UMR AGAP](umr-agap.cirad.fr),

Equipe pédagogique 2026 :

Nicolas SALAS : nicolas.salas@supagro.fr ([Institut Agro Montpellier](https://www.institut-agro-montpellier.fr/)),
Marianne Laurencon : marianne.laurencon@inrae.fr ([AgroParisTech](https://www.agroparistech.fr/),[UMR GQE](http://moulon.inra.fr/)),
...
Vincent Segura : vincent.segura@inrae.fr ([INRAE](https://inrae.fr), [UMR AGAP](umr-agap.cirad.fr))
...
1. Les bases de la prédiction génomique, par Vincent Segura (INRAE, AGAP).
...
(introduction à la prédiction phénomique.)
...
* 9h - 12h: « De la théorie à la routine, comment la sélection génomique est devenue essentielle en sélection variétale – exemples de succès et de limites ». Christopher Sauvage - Syngenta SA France
