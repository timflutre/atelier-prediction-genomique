...
* $f$: fréquence de l'allèle minoritaire à ce SNP (sur un autosome)

* $x_i$: génotype de l'individu $i$ au marqueur SNP d'intérêt, codé comme le nombre de copie(s) de l'allèle minoritaire à ce SNP chez cet individu ($\forall i \; x_i \in \{0,1,2\}$)
...
* citer des référence si nécessaire.s
...
Il est bon, surtout dans ce cas simple, d'implémenter par nous même cette méthode, histoire de mieux la comprendre.
