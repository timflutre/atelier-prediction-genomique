...
```{r additive relationship,fig.width=7, fig.height=7}
# par(mfrow=c(1,1))
# graphics.off()
...
# Sans structure
out.pca.nostruct <- pca(X=X,plot="points")
...
Pour sauvegarder les objets sous forme de liste dans R, on peut utiliser la fonction `save`et enregistrer le fichier sous format `.Rdata`. La fonction pour charger le fichier est `load`.
