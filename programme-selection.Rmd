...
author: "Jacques David et Timothée Flutre"
...
Ce document a pour but d'explorer par simulation les stratégies possibles d'un sélectionneur en prenant un cas *très simplifié* de plante annuelle de type "blé".
...
Les producteurs sont payés à la quantité produite (les rendements sont de l'ordre de 40 kg fleur par ha), mais les transformateurs ont réussi à exiger que la teneur moyenne en sepmetine des lots commerciaux soit au dessus de 15 pour mille. 
...
une puce à haute densité de 10 000 marqueurs SNPs, le génotypage coûtant 150 Mendels par individu, et une puce basse densité de 5000 marqueurs dont le génotypage coûte 10 Mendels.
...
Les données relevées sont la production de fleurs (kg/ha), la teneur en sepmetine (g/kg) et la présence de symptômes causés par *Putrida psychedelica*.
...
La culture et récolte d'une plante individuelle est de 1/100 PE, soit `r cost.PE / 100` Mendels.
...
Au final, l'obtention de la récolte de 1000 graines d'un haploide doublé prend un an et coûte 1/25 PE, soit `r cost.PE / 25` Mendels.

## Récapitulatif des coûts

| Prestation      | Coût (Mendel)   | Coût (PE)
|-----------------|:---------------:|:-------:|
parcelle                  | `r cost.PE`           | 1 
croisement                | `r cost.PE/2`         | 1/2
autofécondation serre     | `r cost.PE/100`       | 1/100
haploide doublé serre     | `r cost.PE/25`        | 1/25
génotypage haute densité  | `r cost.PE * 3`       | 3
génotypage basse densité  | `r cost.PE / 5`       | 1/5
...
Elles devront aussi satisfaire aux critères VATE correspondant à un minimum de 105 % de la productivité brute des 5 meilleurs lignées disponibles pour tous en début de programme.
Les variétés en-dessous du seuil de 14 % de sepmetine seront éliminées.
...
Par exemple, \verb+62-87.1+ est l'identifiant pour un hybride F1 entre les lignées \verb+Coll062+ et \verb+Coll87+ de la collection.
