...
mode: selfcontained
abstract: |
  Ce document présente les objectifs, les pré-requis et le programme de l'atelier de prédiction et sélection génomique pour l'année 2020.
    Cet atelier est destiné aux étudiants en spécialisation APIMET et SEPMET de Montpellier SupAgro et PIST d'AgroParisTech.  
  
  Un peu d'histoire : En 2020, ce sera la 5ème édition de cet atelier construit au départ par Timothée Flûtre, Jacques David, Friedrich Longin et Philippe Brabant, fortement amélioré par Julien Diot pour le jeu sérieux. Il a été encadré par Charlotte Brault,étudiante en thèse et Julie Fiévet. Cette année, Vincent Ségura et Margaux Jullien rejoignent l'équipe.
---
...
* Montpellier SupAgro, campus La Gaillarde, bâtiment 14 de l'annexe de Mandon ([plan](https://www.montpellier-supagro.fr/plan-acces)).
...
**Equipe pédagogique 2020**

Vincent Ségura et Charlottre Brault ([Montpellier SupAgro](http://www.supagro.fr/), [UMR AGAP](http://umr-agap.cirad.fr/), équipe [DAAV](https://umr-agap.cirad.fr/recherche/equipes-scientifiques2/diversite-et-amelioration-de-la-vigne/contexte-et-objectifs))  
...
Philippe Brabant, 
Julien Diot ([The University of Tokyo, Laboratory of Biometry and Bioinformatics](https://www.u-tokyo.ac.jp))
...
+ [MM4LMM](https://cran.r-project.org/package=MM4LMM/), [qqman](https://cran.r-project.org/package=qqman/): pour la génétique d'association;
...
Le copyright appartient à Montpellier SupAgro et à l'Institut National de la Recherche en Agriculture, Alimentation et l'environnement.
...
## Mardi 
Intervenants : Margaux Jullien - Charlotte Brault - Jacques David
...
* 14h00 - 16h00: discussion sur les différentes stratégies suivies ; compléments d'analyses


## Vendredi  
Intervenant : Fridriech Longin
  
* 9h - 12h: cours "Optimization of breeding schemes with GS in R", par F. Longin (document "Selgain_Montpellier_2018.pdf")

* 14h - 15h30: travaux pratiques via des simulations de schémas de sélection (document "Selgain_Montpellier_2018_example.R").


* 15h30 - 16h: discussion sur les acquis réalisés durant l'atelier et les améliorations à apporter