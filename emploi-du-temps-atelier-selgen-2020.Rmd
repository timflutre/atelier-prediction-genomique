...
abstract: |
  ...
  Un peu d'histoire : En 2020, ce sera la 5ème édition de cet atelier construit au départ par Timothée Flûtre, Jacques David, Friedrich Longin et Philippe Brabant, fortement amélioré par Julien Diot pour le jeu sérieux. Il a été encadré par Charlotte Brault,étudiante en thèse et Julie Fiévet. Cette année, Vincent Ségura rejoint l'équipe.
---
...
Vincent Ségura ([Montpellier SupAgro](http://www.supagro.fr/), [UMR AGAP](http://umr-agap.cirad.fr/), équipe [DAAV](https://umr-agap.cirad.fr/recherche/equipes-scientifiques2/diversite-et-amelioration-de-la-vigne/contexte-et-objectifs)  
...
Philippe Brabant
Julien Diot ([INRA](http://www.inra.fr/), UMR [GQE](http://moulon.inra.fr/))
