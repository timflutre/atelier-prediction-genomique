...
Dans le cas de la régression linéaire, ceci peut se faire à l'aide du coefficient de détermination, interprété comme la proportion de la variance phénotypique expliquée par le modèle:
...
\[
\boldsymbol{y} | W, X, \boldsymbol{\alpha}, \boldsymbol{\beta}, \sigma \; \sim \mathcal{N}_n(W \boldsymbol{\alpha} + X \boldsymbol{\beta}, \Sigma) \text{ avec } \Sigma = \sigma I_n
\]
