...
Mais, de façon plus intéressante, nous voudrions évaluer les prédictions phénotypes sur $n_{\text{new}}$ nouveaux individus.
...
plot(x=y.new, y=y.new.tilde, las=1,
     xlab=expression(paste("Nouveaux phénotypes, ", bold(y)[new])),
     ylab=expression(paste("Phénotypes prédits, ", bold(tilde(y))[new])))
...
On retrouve bien une forte corrélation positive puisqu'on a utilisé $\rho$ = `r rho` dans les simulations.
