...
beta[sample.int(P, nb.qtls)] <- rnorm(n=nb.qtls, mean=0, sd=1)
var(beta)
(sigma.beta2 <- var(X %*% beta)[1,1])
h2 <- 0.60
(sigma.epsilon2 <- ((1 - h2) / h2) * sigma.beta2)
...
fit.BGLR$SD.varE
c(var(beta), fit.BGLR$ETA[[2]]$varB)
...
abline(v=var(beta), col="red", lty=2)
